...
window.ApicemPreview = (function () {
  ...
  function buildSVG() {
    return [
      ...
      '  <defs>',
      '    <!-- Organic wood grain: directional turbulence, values clamped to [0.28,0.73] so soft-light never bleaches -->',
      ...
      '  <path    id="apicem-caixa"            stroke="rgba(43,36,32,0.45)" stroke-width="1.5" stroke-linejoin="round" style="display:none;transition:fill .3s ease"/>',
      '</svg>',
    ].join('\n');
  }
