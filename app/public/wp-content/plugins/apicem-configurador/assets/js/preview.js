...
window.ApicemPreview = (function () {
  ...
  function buildSVG() {
    return [
      ...
      '     role="img" aria-label="Preview da mesa" style="width:100%;height:auto;isolation:isolate">',
      '  <defs>',
      ...
      '      <!-- Luminance mask: white PNG background → alpha=0, desk surfaces → alpha=1 -->',
      '      <feColorMatrix in="SourceGraphic" type="luminanceToAlpha" result="luma"/>',
      '      <feComponentTransfer in="luma" result="deskMask">',
      '        <feFuncA type="linear" slope="-3" intercept="3"/>',
      '      </feComponentTransfer>',
      '      <feComposite in="blended" in2="deskMask" operator="in"/>',
      '    </filter>',
      '  </defs>',
      '',
